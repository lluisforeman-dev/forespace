...
FACETS = {
    ...
    'technology': {
        ...
        'nodes': [
            ...
            ('electric_propulsion', 'Electric / Ion Propulsion', 'Ion thrusters, Hall-effect thrusters, gridded ion engines.', ['Starlink V2 Starship', 'Safran']),
            ...
            ('sar', 'SAR (Synthetic Aperture Radar)', 'Radar imaging satellites operating in cloudy/night conditions.', ['Capella Space', 'ICEYE']),
            ...
            ('direct_to_cell', 'Direct-to-Cell Connectivity', 'Satellites communicating directly with standard mobile handsets.', ['AST SpaceMobile', 'Starlink']),
        ],
    },
    'adjacent_sector': {
